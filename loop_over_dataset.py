...
#
# You should have received a copy of the Udacity license togetfSHOWher with this program.
#
...
#results_fullpath = os.path.join('/home/workspace/', 'results/' + model + '/results_sequence_' + sequence + '_' + model)
...
while True:
    try:
        ...
        if 'show_objects_in_bev_labels_in_camera' in exec_list:
            print("HXHXHXHXHXHXHXHHXHXHXHHXHXHXHHXHXHXXHHXHXHHHXHXHXHHXHXHHXHXHXHXHHXHXHXHHXHXHHXHXHXHXHHXHXH")
